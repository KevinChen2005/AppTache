...
@interface FJMarqueeLabel ()<UIScrollViewDelegate>{
    NSTimer *_timer;
...
-(void)commonInit
{
    self.marqueeLabelType = FJMarqueeLabelTypeLeft;
...
-(void)drawTextInRect:(CGRect)rect
{
    ...
    if (self.marqueeLabelType == FJMarqueeLabelTypeLeft) {
